      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav side-nav">
            <li class="active"><a href="/nyari-admin"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-caret-square-o-down"></i> Events<b class="caret"></b></a>
              <ul class="dropdown-menu">
                <li><a href="/nyari-admin/events">Events List</a></li>
                <li><a href="/nyari-admin/events/create">Create Event</a></li>
              </ul>
          ...
          <ul class="nav navbar-nav navbar-right navbar-user">
            <li class="dropdown user-dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="/"><i class="fa fa-home"></i> Visit Home</a></li>
                <li class="divider"></li>
